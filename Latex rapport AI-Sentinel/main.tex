...
\section{Manuel utilisateur (Windows)}
Pour exécuter le système complet de surveillance sous Windows, deux méthodes sont possibles :

\subsection*{Option 1 : Via l'invite de commandes}
...
\subsection*{Option 2 : Lancement rapide ("Zéro Manipulation")}
